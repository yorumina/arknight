...
FetchContent_Declare(
    ...
    URL  https://github.com/Perlmint/glew-cmake/archive/918ece3da858c2e28e10f6507378af01647cb139.zip
...
FetchContent_Declare(
    ...
    URL  https://github.com/libsdl-org/SDL_ttf/archive/db1e6d14494bfffe464c50667a26941cc3a36324.zip
...
FetchContent_MakeAvailable(glew sdl2 sdl2_image sdl2_ttf sdl2_mixer spdlog glm googletest imgui)

set(PTSD_NLOHMANN_JSON_INCLUDE_DIR
    ${CMAKE_CURRENT_SOURCE_DIR}/third_party/nlohmann_json/include
)

if (NOT EXISTS ${PTSD_NLOHMANN_JSON_INCLUDE_DIR}/nlohmann/json.hpp)
    message(FATAL_ERROR "Missing third_party nlohmann/json.hpp at ${PTSD_NLOHMANN_JSON_INCLUDE_DIR}")
endif()

add_library(nlohmann_json INTERFACE)
add_library(nlohmann_json::nlohmann_json ALIAS nlohmann_json)
target_include_directories(nlohmann_json INTERFACE
    ${PTSD_NLOHMANN_JSON_INCLUDE_DIR}
)
